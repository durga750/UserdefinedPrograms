...
namespace AdomNum
{
    class GetMaxDigitArray
    {

        public static int GetMaxNumber(int[] array)
        {
            return ArrayToNum(SortArrayDesc(GetMaxDigitArra(array)));
        }


        private static int[] GetMaxDigitArra(int[] array)//{456,678,659}=>{6,8,9}
        {
        ...
        {
            int[] array = { 123, 456, 678, 980 ,234567};
